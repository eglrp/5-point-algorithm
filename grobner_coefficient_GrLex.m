function M = grobner_coefficient_GrLex( EE )
...
for i = 1:10
    M2 = coeffs(M1(i,:));
    M(i,:) = [M2(20) M2(19) M2(18) M2(16) M2(15) M2(13) M2(10) M2(9) M2(7) M2(4)...
    M2(17) M2(14) M2(12) M2(8) M2(6) M2(3) M2(11) M2(5) M2(2) M2(1)];
end